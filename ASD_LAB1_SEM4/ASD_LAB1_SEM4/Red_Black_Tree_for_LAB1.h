...
private:
	...
	public:
		...
		Element_Red_Black_Tree(int color = red, T1 key = 0, T2 value = 0, Element_Red_Black_Tree* parent_node = nullptr, Element_Red_Black_Tree* left_node = nullptr, Element_Red_Black_Tree* right_node = nullptr)
		{
			this->color = color;
			this->key = key;
			this->value = value;
